...
export const SERVICE_DETAILS: Record<string, ServiceDetail> = {
  exterior: {
    ...
    longDescription: [
      ...
      "From there we move to paint-safe drying and polishing to knock back haze and bring the gloss back, then clean the wheels, tires, and rims and lay down a tire protectant so they hold their look. We restore foggy, yellowed headlights so your lights actually project at night, recondition the faded exterior plastic and rubber trim that Michigan sun chalks out, and clean up the engine bay so the whole car looks cared for, not just the outside panels.",
    ...
    process: [
      ...
      { title: "Engine bay and final check", body: "We clean up the engine bay and walk the whole vehicle one more time so it leaves clean, protected, and ready to drive, at our shop or your location." },
    ],
    faqs: [
      { q: "What is the difference between this and a car wash?", a: "A car wash rinses off loose surface dirt. Our exterior detail hand washes the vehicle and then clay bars the paint to physically remove the road tar, brake dust, and bonded contaminants that stay stuck after any wash, plus we polish, restore the headlights, recondition the trim, detail the wheels, and clean the engine bay." },
  ...
  "marine-rv": {
    ...
    process: [
      { title: "Walk the unit and quote it", body: "We look over the hull or RV body, check how much oxidation has set in, and inspect the interior. Then you get a flat written quote before we start, so the price is set up front." },
    ...
    faqs: [
      ...
      { q: "How much does marine or RV detailing cost?", a: "We quote each unit individually because boats and RVs vary so much in size, surface condition, and how much oxidation has set in. We walk the unit, look at the gel coat and interior, and give you a flat written quote before any work starts. Call (586) 217-0123 to set it up." },
    ...
    whyUs: [
      ...
      "Flat written quote before any work starts, with no surprise add-ons",
...
export const ABOUT = {
  ...
  pillars: [
    ...
    { icon: "Anchor", title: "Marine and RV", body: "Boats and RVs get the same certified care, sized to the rig and quoted per vehicle." },
  ],
} as const;
...
export const SEO: Record<string, { title: string; description: string }> = {
  ...
  "paint-correction": {
    ...
    description:
      "Multi-stage paint correction in St. Clair Shores removes swirls and scratches for a deep gloss. Certified Nasiol, 3M, 3D. Call (586) 217-0123.",
  },
  "ceramic-coating": {
  ...
  gallery: {
    ...
    description:
      "See before-and-after detailing work on cars, trucks, boats, and RVs by Bubbles Auto Spa in St. Clair Shores, MI. Call (586) 217-0123 for a quote.",
  },
  about: {
...
// (create one for the business inbox and lock it to the live origin). Until then
// the form logs the lead client-side and still routes to /thank-you, so the flow
// is testable without delivering to the wrong inbox.
